...
/* ── Bundled playlist ─────────────────────────────────────────
   Real audio files + metadata, shipped in /assets.
─────────────────────────────────────────────────────────────── */
const BUNDLED_TRACKS = [
  {
    ...
    cover:  'assets/covers/track1.jpg',
  },
  {
...
/* ── Initialize with bundled tracks ───────────────────────── */
function init() {
  state.tracks = BUNDLED_TRACKS.map(t => ({ ...t, file: null, duration: 0, favorite: false }));
  renderPlaylist();
  loadTrack(0);
}
